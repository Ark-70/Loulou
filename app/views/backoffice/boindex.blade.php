            ...
            <div class="modal-body">
              <table class="table">
                ...
                foreach ($tiles as $tile) {
                  ...
                  <form action="{{url('/tile/edit')}}" method="POST">
                      <input type="text" name="id" value="<?php echo $tile['id'] ?>" hidden>
                      <input type="text" name="title" value="<?php echo $tile['title'] ?>" hidden>
                      <input type="text" name="description" value="<?php echo $tile['description'] ?>" hidden>
                      <input type="text" name="layout" value="<?php echo $tile['layout'] ?>" hidden>
                      <td><button id="btnedit" type="submit" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></td>
                  </form>
                    </tr>
